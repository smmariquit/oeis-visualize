  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "And digit games can lead to entirely serious mathematics. The look-and-say sequence starts at 1 and each term reads the previous one aloud: 1, 11 (\"one 1\"), 21 (\"two 1s\"), 1211, 111221, 312211. It looks like a children's riddle. John Conway analyzed it and found something absurdly deep: the term lengths grow by a fixed factor, now called Conway's constant, approximately 1.3036, which is an algebraic number, the root of a specific polynomial of degree 71. A rule about reading digits aloud secretly encodes a degree-71 polynomial. That is the recurring joke of this whole subject, and by now you can see it coming.",
