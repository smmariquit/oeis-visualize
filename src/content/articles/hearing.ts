  ...
  sections: [
    {
      ...
      body: [
        ...
        "Sonification, turning data into sound, is the auditory sibling of visualization, and it is older than it sounds. The Geiger counter is a sonification: radiation level mapped to click rate, read by ear precisely because ears track rates effortlessly while eyes are busy elsewhere. The most famous scientific sound of this century is another one: when LIGO announced the first gravitational-wave detection in 2016, the signal was presented to the world as a chirp, a rising whoop as two black holes spiraled together, because the wave's frequencies happened to fall in the human audible range and playing them was the fastest way to make a billion-year-old collision comprehensible. The research field that studies such displays defines sonification as the transformation of data relations into perceived relations in an acoustic signal [2]. Everything in this article is that one sentence, applied to integer sequences.",
      ],
    },
    {
      id: "hearing-oeis",
    ...
    },
    {
      ...
      body: [
        ...
        "Modular mapping, which this app and the OEIS both default to, takes each term's remainder by some k and lets the remainder pick a note. It happily discards growth altogether: Fibonacci's explosion is inaudible. In exchange it preserves the thing number theory actually lives in, modular arithmetic. A sequence that is periodic modulo k becomes a literally repeating melody; divisibility patterns become recurring motifs; a change in modular behavior is a change of tune you cannot miss. The choice between the two mappings is a choice of what question to ask, which by now is a familiar theme.",
    ...
    },
    {
      ...
      body: [
        ...
        "True to this project's theme, even these tidy loops hide an open problem. For every prime p anyone has ever checked, the period mod $p^2$ is exactly p times the period mod p. Donald Wall asked in 1960 whether that could ever fail; a prime where it does is now called a Wall-Sun-Sun prime, and none has ever been found, though distributed searches have combed far beyond $10^{17}$ candidates. Nobody has proved one exists, and nobody has proved one does not. Every Pisano period you will ever hear in this app obeys Wall's pattern, and mathematics cannot yet promise that the music never breaks it [4].",
      ],
